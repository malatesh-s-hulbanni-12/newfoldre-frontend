...
function FetchDataPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get('https://newfolder-backend-583v.vercel.app/api/data')
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => {
                axios.get('https://newfolder-backend-583v.vercel.app/api/data')
                  .then(res => {
        ...
        {loading && (
          <div className="flex justify-center items-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">Connected to: https://newfolder-backend-583v.vercel.app//api/data</p>
            </div>
          </div>
        )}
